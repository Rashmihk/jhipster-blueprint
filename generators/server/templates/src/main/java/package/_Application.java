...
/**
 * Scan for any @Entity classes with a base package of "com.fhlbny"
 */
@EntityScan(basePackages = {"com.fhlbny","<%=packageName%>"})

/**
 * LiquibaseAutoConfiguration added in exclusion list to remove liquibase
 */
@EnableAutoConfiguration(exclude = {MetricFilterAutoConfiguration.class, MetricRepositoryAutoConfiguration.class<% if (applicationType === 'gateway') { %>, MetricsDropwizardAutoConfiguration.class<% } %>, LiquibaseAutoConfiguration.class})
...
<%_ } _%>
/**
 * annotation to apply jasypt encryption configuration
 */
