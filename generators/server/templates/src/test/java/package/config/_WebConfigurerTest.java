...
//        Builder builder = tomcat.builder();
//        container.getBuilderCustomizers().forEach(c -> c.customize(builder));
//        OptionMap.Builder serverOptions = (OptionMap.Builder) ReflectionTestUtils.getField(builder, "serverOptions");
//        assertThat(serverOptions.getMap().get(tomcatOptions.ENABLE_HTTP2)).isNull();
    }
...
//    @Test
//    public void testtomcatHttp2Enabled() {
...
//    }
    ...
    // emott: We are maintaining our own CORS filter, so commenting out this test that doesn't apply
//    @Test
