...
import { <%= entityAngularName %>EditComponent } from '../../../../../../main/webapp/app/entities/<%= entityFolderName %>/<%= entityFileName %>-edit.component';
...
describe('Component Tests', () => {
    ...
    describe('<%= entityAngularName %> Management Dialog Component', () => {
        let comp: <%= entityAngularName %>EditComponent;
        let fixture: ComponentFixture<<%= entityAngularName %>EditComponent>;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [<%= entityAngularName %>EditComponent],
                providers: [
            ...
            .overrideTemplate(<%= entityAngularName %>EditComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(<%= entityAngularName %>EditComponent);
