...
import { <%= entityAngularName %>ListComponent } from '../../../../../../main/webapp/app/entities/<%= entityFolderName %>/<%= entityFileName %>-list.component';
...
describe('Component Tests', () => {
    ...
    describe('<%= entityAngularName %> Management Component', () => {
        let comp: <%= entityAngularName %>ListComponent;
        let fixture: ComponentFixture<<%= entityAngularName %>ListComponent>;
        let service: <%= entityAngularName %>Service;

        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [<%=angularXAppName%>TestModule],
                declarations: [<%= entityAngularName %>ListComponent],
                providers: [
                    <%= entityAngularName %>Service
                ]
            })
            .overrideTemplate(<%= entityAngularName %>ListComponent, '')
            .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(<%= entityAngularName %>ListComponent);
